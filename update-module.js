...
moduleData.manifest = `https://github.com/gambit07/gambitsEmoteBar/releases/latest/download/module.json`;
moduleData.download = `https://github.com/gambit07/gambitsEmoteBar/releases/download/${version}/module.zip`;
